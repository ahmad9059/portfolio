...
export declare const partition: <T>(arr: T[], isLeft: (_: T) => boolean) => [T[], T[]];
...
declare const RawError_base: import("@effect-ts/system/Case").CaseConstructorTagged<"RawError", "_tag">;
export declare class RawError extends RawError_base<{
    readonly error: unknown;
}> {
}
export declare const isReadonlyArray: <T>(_: any) => _ is readonly T[];
export declare const assertNever: (_: any) => never;
