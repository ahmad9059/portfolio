...
var import_optional = require("./optional.js");
function collect(f) {
  return (self) => collect_(self, f);
}
function collect_(self, f) {
  return (0, import_core.map_)((0, import_excl_forEach.forEach_)(self, (a) => (0, import_optional.optional)(f(a))), import_compact.compact);
}
