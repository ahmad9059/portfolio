 ...
 */
export declare function extend_<E, A, B>(wa: Either<E, A>, f: (wa: Either<E, A>) => B): Either<E, B>;
/**
 * Apply `Either[E, A] => B` in case self is right returning `Either[E, B]`
 *
 * @ets_data_first extend_
 */
export declare function extend<E, A, B>(f: (fa: Either<E, A>) => B): (ma: Either<E, A>) => Either<E, B>;
/**
