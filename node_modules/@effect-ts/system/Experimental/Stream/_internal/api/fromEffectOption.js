...
var fromEffectOption_exports = {};
__export(fromEffectOption_exports, {
...
function fromEffectOption(fa) {
  return new C.Stream(CH.unwrap(T.fold_(fa, O.fold(() => CH.end(void 0), (e) => CH.fail(e)), (a) => CH.write(CK.single(a)))));
}
module.exports = __toCommonJS(fromEffectOption_exports);
