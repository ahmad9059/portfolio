...
var acquireReleaseExitWith_exports = {};
__export(acquireReleaseExitWith_exports, {
  acquireReleaseExitWith: () => acquireReleaseExitWith,
  acquireReleaseExitWith_: () => acquireReleaseExitWith_
});
var M = __toESM(require("../../../../Managed/index.js"));
var Managed = __toESM(require("./managed.js"));
function acquireReleaseExitWith_(acquire, release) {
  return Managed.managed(M.makeExit_(acquire, release));
}
function acquireReleaseExitWith(release) {
  return (acquire) => acquireReleaseExitWith_(acquire, release);
}
module.exports = __toCommonJS(acquireReleaseExitWith_exports);
