...
var scheduleWith_exports = {};
__export(scheduleWith_exports, {
...
function scheduleWith_(self, schedule, f, g) {
  const loop = (driver, chunk, index) => {
    if (index < CK.size(chunk)) {
      ...
      return CH.readWithCause((chunk2) => loop(driver, chunk2, 0), (_) => CH.failCause(_), (_) => CH.end(_));
    }
  };
...
module.exports = __toCommonJS(scheduleWith_exports);
