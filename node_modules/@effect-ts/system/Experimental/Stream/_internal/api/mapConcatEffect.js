...
var mapConcatEffect_exports = {};
__export(mapConcatEffect_exports, {
...
var MapConcatChunk = __toESM(require("./mapConcatChunk.js"));
var MapEffect = __toESM(require("./mapEffect.js"));
function mapConcatEffect_(self, f) {
  return MapConcatChunk.mapConcatChunk_(MapEffect.mapEffect_(self, (a) => T.map_(f(a), CK.from)), import_Function.identity);
}
function mapConcatEffect(f) {
  return (self) => mapConcatEffect_(self, f);
}
module.exports = __toCommonJS(mapConcatEffect_exports);
