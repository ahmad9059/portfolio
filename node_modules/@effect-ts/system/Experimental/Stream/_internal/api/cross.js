...
var CrossWith = __toESM(require("./crossWith.js"));
function cross_(...[s1, s2, ...streams]) {
  const init = CrossWith.crossWith_(s1, s2, Tp.tuple);
  return A.reduce_(streams, init, (acc, v) => CrossWith.crossWith_(acc, v, (a, b) => Tp.append_(a, b)));
}
function cross(...[s1, ...streams]) {
  return (self) => cross_(self, s1, ...streams);
}
