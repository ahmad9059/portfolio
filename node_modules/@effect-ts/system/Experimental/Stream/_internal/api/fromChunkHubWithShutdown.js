...
var fromChunkHubWithShutdown_exports = {};
__export(fromChunkHubWithShutdown_exports, {
...
var FromChunkHub = __toESM(require("./fromChunkHub.js"));
function fromChunkHubWithShutdown(hub) {
  return Ensuring.ensuring_(FromChunkHub.fromChunkHub(hub), H.shutdown(hub));
}
module.exports = __toCommonJS(fromChunkHubWithShutdown_exports);
