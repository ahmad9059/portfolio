...
var unfoldChunksEffect_exports = {};
__export(unfoldChunksEffect_exports, {
...
function unfoldChunksLoop(s, f) {
  return CH.unwrap(T.map_(f(s), O.fold(() => CH.unit, ({
    tuple: [as, s2]
  }) => CH.chain_(CH.write(as), () => unfoldChunksLoop(s2, f)))));
}
function unfoldChunksEffect(s, f) {
  return new C.Stream(unfoldChunksLoop(s, f));
}
module.exports = __toCommonJS(unfoldChunksEffect_exports);
