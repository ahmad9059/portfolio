 ...
 */
export declare function zipAllSortedByKeyRight_<R, R1, E, E1, K, A, B>(self: C.SortedByKey<R, E, K, A>, that: S.Stream<R1, E1, Tp.Tuple<[K, B]>>, default_: B, ord: OD.Ord<K>): S.Stream<R & R1, E | E1, Tp.Tuple<[K, B]>>;
/**
 * Zips this stream that is sorted by distinct keys and the specified
 * stream that is sorted by distinct keys to produce a new stream that is
 * sorted by distinct keys. Keeps only values from that stream, using the
 ...
 */
export declare function zipAllSortedByKeyRight<R1, E1, K, A, B>(that: S.Stream<R1, E1, Tp.Tuple<[K, B]>>, default_: B, ord: OD.Ord<K>): <R, E>(self: C.SortedByKey<R, E, K, A>) => S.Stream<R & R1, E1 | E, Tp.Tuple<[K, B]>>;
