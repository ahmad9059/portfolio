 ...
 */
export declare function foldWeightedEffect<Env, Err, In, S>(z: S, costFn: (s: S, in_: In) => T.Effect<Env, Err, number>, max: number, f: (s: S, in_: In) => T.Effect<Env, Err, S>): C.Sink<Env, Err, In, Err, In, S>;
