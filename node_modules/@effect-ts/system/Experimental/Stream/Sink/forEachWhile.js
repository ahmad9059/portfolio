...
var forEachWhile_exports = {};
__export(forEachWhile_exports, {
...
function forEachWhile(f) {
  ...
  const process = CH.readWithCause((_in) => go(_in, 0, CK.size(_in), process), (halt) => CH.failCause(halt), (_) => CH.end(void 0));
  return new C.Sink(process);
}
module.exports = __toCommonJS(forEachWhile_exports);
