...
var SK = __toESM(require("../Sink/core.js"));
function forEach(f) {
  const process = CH.readWithCause((in_) => CH.zipRight_(CH.fromEffect(T.forEachUnit_(in_, f)), process), (halt) => CH.failCause(halt), (_) => CH.end(void 0));
