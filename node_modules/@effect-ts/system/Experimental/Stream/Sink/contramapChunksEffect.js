...
var contramapChunksEffect_exports = {};
__export(contramapChunksEffect_exports, {
  contramapChunksEffect: () => contramapChunksEffect,
  contramapChunksEffect_: () => contramapChunksEffect_
});
...
module.exports = __toCommonJS(contramapChunksEffect_exports);
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  contramapChunksEffect,
  contramapChunksEffect_
});
