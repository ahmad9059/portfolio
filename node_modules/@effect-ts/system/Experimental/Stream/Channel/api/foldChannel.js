...
var foldChannel_exports = {};
__export(foldChannel_exports, {
  foldChannel: () => foldChannel,
  foldChannel_: () => foldChannel_
});
...
function foldChannel(onErr, onSucc) {
  return (self) => foldChannel_(self, onErr, onSucc);
}
module.exports = __toCommonJS(foldChannel_exports);
