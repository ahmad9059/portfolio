...
function runManaged(self) {
  return M.mapM_(M.makeExit_(T.succeedWith(() => new Executor.ChannelExecutor(() => self, void 0, import_Function.identity)), (exec, exit) => exec.close(exit) || T.unit), (exec) => T.suspend(() => runManagedInterpret(exec.run(), exec)));
}
module.exports = __toCommonJS(runManaged_exports);
