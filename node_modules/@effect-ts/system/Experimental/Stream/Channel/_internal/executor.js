...
__export(executor_exports, {
  ...
  ChannelStateDone: () => ChannelStateDone,
  ChannelStateDoneTypeId: () => ChannelStateDoneTypeId,
  ChannelStateEffect: () => ChannelStateEffect,
  ChannelStateEffectTypeId: () => ChannelStateEffectTypeId,
  ChannelStateEmit: () => ChannelStateEmit,
  ChannelStateEmitTypeId: () => ChannelStateEmitTypeId,
  FromKAnd: () => FromKAnd,
  FromKAndTypeId: () => FromKAndTypeId,
  Inner: () => Inner,
  InnerTypeId: () => InnerTypeId,
  channelStateEffect: () => channelStateEffect,
  channelStateUnroll: () => channelStateUnroll,
  maybeCloseBoth: () => maybeCloseBoth
});
var import_Operator = require("../../../../Operator/index.js");
var L = __toESM(require("../../../../Collections/Immutable/List/index.js"));
var T = __toESM(require("../../../../Effect/index.js"));
var Either = __toESM(require("../../../../Either/index.js"));
...
class ChannelExecutor {
  ...
  close(ex) {
    const runInProgressFinalizer = this.inProgressFinalizer ? T.ensuring_(this.inProgressFinalizer, T.succeedWith(() => this.clearInProgressFinalizer())) : void 0;
