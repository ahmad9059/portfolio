...
export function ensuring_(effect, finalizer, __trace) {
  return uninterruptibleMask(({
    restore
  }) => foldCauseM_(restore(effect), cause1 => foldCauseM_(finalizer, cause2 => halt(then(cause1, cause2)), _ => halt(cause1)), value => foldCauseM_(finalizer, cause1 => halt(cause1), _ => succeed(value)), __trace));
}
