...
export const CauseSym = /*#__PURE__*/Symbol();
export function isCause(self) {
...
export function traced(cause, trace) {
...
export function equals(self, that) {
