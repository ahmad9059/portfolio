...
export const FromKAndTypeId = /*#__PURE__*/Symbol();
export class FromKAnd {
...
export const InnerTypeId = /*#__PURE__*/Symbol();
export class Inner {
...
export const ChannelStateDoneTypeId = /*#__PURE__*/Symbol();
...
export const ChannelStateEmitTypeId = /*#__PURE__*/Symbol();
...
export const ChannelStateEffectTypeId = /*#__PURE__*/Symbol();
export class ChannelStateEffect {
  constructor(effect) {
    this.effect = effect;
...
export function channelStateEffect(state) {
...
export function channelStateUnroll(runStep) {
  const step = runStep();
...
export function maybeCloseBoth(l, r) {
  if (l && r) {
