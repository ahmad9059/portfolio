...
export function addToCache(value, cache) {
...
export function hasPair(pairs, pairToMatch, isEqual, meta) {
  const {
    length
  } = pairs;
  let pair;
...
export function hasValue(values, valueToMatch, isEqual, meta) {
  const {
    length
  } = values;
...
export function getNewCacheFallback() {
...
export const getNewCache = /*#__PURE__*/(canUseWeakMap => {
  if (canUseWeakMap) {
...
export function createCircularEqualCreator(isEqual) {
...
export function areArraysEqual(a, b, isEqual, meta) {
  const {
    length
  } = a;
...
export function areMapsEqual(a, b, isEqual, meta) {
  if (a.size !== b.size) {
    return false;
  }
...
export function areObjectsEqual(a, b, isEqual, meta) {
  const keysA = keys(a);
  const {
    length
  } = keysA;
...
export function areSetsEqual(a, b, isEqual, meta) {
  if (a.size !== b.size) {
    return false;
  }
