import { areArraysEqual, areMapsEqual, areObjectsEqual, areRegExpsEqual, areSetsEqual, isPlainObject, isPromiseLike, sameValueZeroEqual } from "./utils.js";
const {
  isArray
} = Array;
...
export function createComparator(createIsEqual) {
