...
export function combineHash(a, b) {
  return opt(_combineHash(a, b));
}
export function hashObject(value) {
  return opt(_hashObject(value));
}
export function hashMiscRef(o) {
  return opt(_hashMiscRef(o));
}
export function hashIterator(it) {
  return opt(_hashIterator(it));
}
export function hashPlainObject(o) {
...
const RANDOM = /*#__PURE__*/new PCGRandom( /*#__PURE__*/Math.random() * 4294967296 >>> 0);
const CACHE = /*#__PURE__*/new WeakMap();
export function randomInt() {
  return RANDOM.integer(0x7fffffff);
}
export function _hash(arg) {
...
export function _hashArray(arr) {
  let h = 6151;
...
export function _combineHash(a, b) {
  return a * 53 ^ b;
}
...
export function _hashObject(value) {
  if (hasHash(value)) {
...
export function _hashMiscRef(o) {
  let h = CACHE.get(o);
  if (isDefined(h)) return h;
  h = randomInt();
  CACHE.set(o, h);
...
export function _hashIterator(it) {
  let h = 6151;
  let current;
...
export function _hashPlainObject(o) {
