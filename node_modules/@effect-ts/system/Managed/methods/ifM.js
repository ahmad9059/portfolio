...
function ifM_(b, onTrue, onFalse, __trace) {
  return (0, import_core.chain_)(b, (x) => x ? onTrue() : onFalse(), __trace);
}
function _if(onTrue, onFalse) {
  return (b) => if_(b, onTrue, onFalse);
}
function if_(b, onTrue, onFalse, __trace) {
  return ifM_((0, import_succeed.succeed)(b), onTrue, onFalse, __trace);
}
module.exports = __toCommonJS(ifM_exports);
