...
__export(RedBlackTree_exports, {
  ...
  find: () => find,
  findFirst: () => findFirst,
  findFirst_: () => findFirst_,
  find_: () => find_,
  forEach: () => forEach,
  forEachBetween: () => forEachBetween,
  forEachBetween_: () => forEachBetween_,
  forEachGe: () => forEachGe,
  forEachGe_: () => forEachGe_,
  forEachLt: () => forEachLt,
  forEachLt_: () => forEachLt_,
  forEach_: () => forEach_,
  from: () => from,
  ge: () => ge,
  ge_: () => ge_,
  ...
  removeFirst_: () => removeFirst_,
  size: () => size,
  values: () => values,
  values_: () => values_,
  visitBetween: () => visitBetween,
  visitFull: () => visitFull,
  visitGe: () => visitGe,
  visitLt: () => visitLt
});
...
function insert_(self, key, value) {
  ...
  n_stack.push(new Node("Red", key, value, void 0, void 0, 1));
...
function visitFull(node, visit) {
  ...
  while (!done) {
    if (current) {
      stack = new import_Stack.Stack(current, stack);
...
class RedBlackTreeIterator {
  ...
  get entry() {
    if (this.stack.length > 0) {
      return O.some((0, import_Function.tuple)(this.stack[this.stack.length - 1].key, this.stack[this.stack.length - 1].value));
    }
    return O.none;
  }
  get index() {
...
module.exports = __toCommonJS(RedBlackTree_exports);
