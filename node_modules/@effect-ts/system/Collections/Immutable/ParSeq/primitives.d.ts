 ...
 */
export declare function both_<A, A1>(left: ParSeq<A>, right: ParSeq<A1>): ParSeq<A | A1>;
/**
 * Combines this collection of events with that collection of events to
 * return a new collection of events that represents this collection of
 * events in parallel with that collection of events.
 ...
 */
export declare function both<A1>(right: ParSeq<A1>): <A>(left: ParSeq<A>) => ParSeq<A | A1>;
/**
 * Combines this collection of events with that collection of events to
 * return a new collection of events that represents this collection of
 * events followed by that collection of events.
 */
export declare function then_<A, A1>(left: ParSeq<A>, right: ParSeq<A1>): ParSeq<A | A1>;
/**
 * Combines this collection of events with that collection of events to
 * return a new collection of events that represents this collection of
 * events followed by that collection of events.
 ...
 */
export declare function then<A1>(right: ParSeq<A1>): <A>(left: ParSeq<A>) => ParSeq<A | A1>;
/**
