...
var RingBuffer_exports = {};
__export(RingBuffer_exports, {
...
class RingBuffer {
  constructor(size, ignoreFn) {
    ...
    this.values = new import_DoublyLinkedList.DoublyLinkedList();
    this.ignored = 0;
  }
  push(value) {
...
module.exports = __toCommonJS(RingBuffer_exports);
