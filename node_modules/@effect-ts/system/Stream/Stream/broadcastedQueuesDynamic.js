...
var broadcastedQueuesDynamic_exports = {};
__export(broadcastedQueuesDynamic_exports, {
...
var import_toHub = require("./toHub.js");
function broadcastedQueuesDynamic_(self, maximumLag) {
  return M.map_((0, import_toHub.toHub_)(self, maximumLag), (_) => H.subscribe(_));
}
function broadcastedQueuesDynamic(maximumLag) {
  return (self) => broadcastedQueuesDynamic_(self, maximumLag);
}
module.exports = __toCommonJS(broadcastedQueuesDynamic_exports);
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  broadcastedQueuesDynamic,
  broadcastedQueuesDynamic_
});
