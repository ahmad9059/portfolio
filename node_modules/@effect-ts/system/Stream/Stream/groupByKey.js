...
var groupByKey_exports = {};
__export(groupByKey_exports, {
...
function groupByKey_(self, f, buffer = 16) {
  return (0, import_groupBy.groupBy_)(self, (a) => T.succeed(Tp.tuple(f(a), a)), buffer);
}
function groupByKey(f, buffer = 16) {
  return (self) => groupByKey_(self, f, buffer);
}
module.exports = __toCommonJS(groupByKey_exports);
