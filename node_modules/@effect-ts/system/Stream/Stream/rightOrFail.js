...
var rightOrFail_exports = {};
__export(rightOrFail_exports, {
...
function rightOrFail_(self, e) {
  return (0, import_mapM.mapM_)(self, E.fold((_) => T.fail(e), (_) => T.succeed(_)));
}
function rightOrFail(e) {
  return (self) => rightOrFail_(self, e);
}
module.exports = __toCommonJS(rightOrFail_exports);
