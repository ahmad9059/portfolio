...
var forever_exports = {};
__export(forever_exports, {
  forever: () => forever
});
var C = __toESM(require("../../Cause/index.js"));
var import_Function = require("../../Function/index.js");
var O = __toESM(require("../../Option/index.js"));
var Pull = __toESM(require("../../Stream/Pull/index.js"));
...
function forever(self) {
  return new import_definitions.Stream(M.map_(M.tap_(M.bind_(M.bind_(M.do, "currStream", () => T.toManaged(Ref.makeRef(Pull.end))), "switchStream", () => M.switchable()), ({
    currStream,
    switchStream
  }) => {
...
module.exports = __toCommonJS(forever_exports);
