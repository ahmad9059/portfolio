...
function managed(self) {
  return new import_definitions.Stream(M.map_(M.let_(M.bind_(M.bind_(M.do, "doneRef", () => Ref.makeManagedRef(false)), "finalizer", () => M.makeManagedReleaseMap(T.sequential)), "pull", ({
    doneRef,
    finalizer
