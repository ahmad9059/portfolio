...
var collectM_exports = {};
__export(collectM_exports, {
  collectM: () => collectM,
  collectM_: () => collectM_
});
...
function collectM_(self, f) {
  return new import_definitions.Stream(M.map_(M.let_(M.bind_(M.do, "as", () => M.mapM_(self.proc, BP.make)), "pull", ({
    as
  }) => {
...
module.exports = __toCommonJS(collectM_exports);
