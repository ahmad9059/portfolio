...
var takeUntil_exports = {};
__export(takeUntil_exports, {
  takeUntil: () => takeUntil,
...
function takeUntil_(self, pred) {
  return new import_definitions.Stream(M.map_(M.let_(M.bind_(M.bind_(M.do, "chunks", () => self.proc), "keepTakingRef", () => T.toManaged(Ref.makeRef(true))), "pull", ({
    chunks,
    keepTakingRef
  }) => {
    return T.chain_(keepTakingRef.get, (keepTaking) => {
      if (!keepTaking) {
        ...
        return T.map_(T.let_(T.let_(T.bind_(T.do, "chunk", () => chunks), "taken", ({
          chunk
        }) => A.takeWhile_(chunk, (0, import_Function.not)(pred))), "last", ({
          chunk,
          taken
...
module.exports = __toCommonJS(takeUntil_exports);
