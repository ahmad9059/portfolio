...
__export(timeoutTo_exports, {
  ...
  isStreamTimeout: () => isStreamTimeout,
  timeoutTo: () => timeoutTo
});
var C = __toESM(require("../../Cause/index.js"));
var import_Function = require("../../Function/index.js");
var O = __toESM(require("../../Option/index.js"));
var import_catchSome = require("./catchSome.js");
var import_timeoutErrorCause = require("./timeoutErrorCause.js");
var _a;
...
function timeoutTo(d) {
  return (that) => (self) => (0, import_catchSome.catchSome)((e) => {
    if (isStreamTimeout(e)) {
      return O.some(that);
    }
    return O.none;
  })((0, import_timeoutErrorCause.timeoutErrorCause)(C.die(new StreamTimeoutError()))(d)(self));
}
