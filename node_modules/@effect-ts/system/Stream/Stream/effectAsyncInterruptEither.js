...
var effectAsyncInterruptEither_exports = {};
__export(effectAsyncInterruptEither_exports, {
  effectAsyncInterruptEither: () => effectAsyncInterruptEither
});
...
function effectAsyncInterruptEither(register, outputBuffer = 16) {
  return new import_definitions.Stream(M.map_(M.bind_(M.bind_(M.bind_(M.bind_(M.do, "output", () => T.toManaged(Q.makeBounded(outputBuffer))), "runtime", () => T.toManaged(T.runtime())), "eitherStream", ({
    output,
    runtime
...
module.exports = __toCommonJS(effectAsyncInterruptEither_exports);
