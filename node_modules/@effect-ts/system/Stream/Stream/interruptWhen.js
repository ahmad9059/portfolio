...
var interruptWhen_exports = {};
__export(interruptWhen_exports, {
  interruptWhen: () => interruptWhen,
  interruptWhen_: () => interruptWhen_
});
...
function interruptWhen_(self, io) {
  return new import_definitions.Stream(M.map_(M.bind_(M.bind_(M.do, "as", () => self.proc), "runIO", () => T.forkManaged(T.zipRight_(T.asSomeError(io), T.fail(O.none)))), ({
    as,
    runIO
...
module.exports = __toCommonJS(interruptWhen_exports);
