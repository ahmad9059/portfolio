...
var throttleEnforce_exports = {};
__export(throttleEnforce_exports, {
  throttleEnforce: () => throttleEnforce,
  throttleEnforce_: () => throttleEnforce_
});
var T = __toESM(require("../_internal/effect.js"));
var import_throttleEnforceM = require("./throttleEnforceM.js");
...
function throttleEnforce_(self, costFn, units, duration, burst = 0) {
  return (0, import_throttleEnforceM.throttleEnforceM_)(self, (os) => T.succeed(costFn(os)), units, duration, burst);
}
module.exports = __toCommonJS(throttleEnforce_exports);
