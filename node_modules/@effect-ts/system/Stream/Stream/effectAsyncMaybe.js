...
var effectAsyncMaybe_exports = {};
__export(effectAsyncMaybe_exports, {
  effectAsyncMaybe: () => effectAsyncMaybe
});
...
function effectAsyncMaybe(register, outputBuffer = 16) {
  return new import_definitions.Stream(M.map_(M.bind_(M.bind_(M.bind_(M.bind_(M.do, "output", () => T.toManaged(Q.makeBounded(outputBuffer))), "runtime", () => T.toManaged(T.runtime())), "maybeStream", ({
    output,
    runtime
...
module.exports = __toCommonJS(effectAsyncMaybe_exports);
