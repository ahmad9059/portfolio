...
var collectWhileMap_exports = {};
__export(collectWhileMap_exports, {
  collectWhile: () => collectWhile,
  collectWhileMap: () => collectWhileMap,
  collectWhileMap_: () => collectWhileMap_,
...
function collectWhileMap_(self, f) {
  return new import_definitions.Stream(M.map_(M.let_(M.bind_(M.bind_(M.do, "chunks", () => self.proc), "doneRef", () => T.toManaged(Ref.makeRef(false))), "pull", ({
    chunks,
    doneRef
...
module.exports = __toCommonJS(collectWhileMap_exports);
