...
var unfoldChunkM_exports = {};
__export(unfoldChunkM_exports, {
  unfoldChunkM: () => unfoldChunkM
});
...
function unfoldChunkM(z, f) {
  return new import_definitions.Stream(M.map_(M.let_(M.bind_(M.bind_(M.do, "done", () => Ref.makeManagedRef(false)), "ref", () => Ref.makeManagedRef(z)), "pull", ({
    done,
    ref
...
module.exports = __toCommonJS(unfoldChunkM_exports);
