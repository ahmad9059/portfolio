...
var mapChunksM_exports = {};
__export(mapChunksM_exports, {
...
function mapChunksM_(self, f) {
  return new import_definitions.Stream(M.map_(self.proc, (e) => T.chain_(e, (x) => T.mapError_(f(x), O.some))));
}
function mapChunksM(f) {
  return (self) => mapChunksM_(self, f);
}
module.exports = __toCommonJS(mapChunksM_exports);
