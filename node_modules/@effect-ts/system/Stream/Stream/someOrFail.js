...
var someOrFail_exports = {};
__export(someOrFail_exports, {
...
function someOrFail_(self, f) {
  return (0, import_mapM.mapM_)(self, O.fold(() => T.fail(f()), (_) => T.succeed(_)));
}
function someOrFail(f) {
  return (self) => someOrFail_(self, f);
}
module.exports = __toCommonJS(someOrFail_exports);
