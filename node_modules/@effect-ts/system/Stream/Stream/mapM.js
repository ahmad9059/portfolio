...
function mapM_(self, f) {
  return new import_definitions.Stream(M.map_(M.mapM(BP.make)(self.proc), (pull) => T.chain_(BP.pullElement(pull), (o) => T.bimap(O.some, (o1) => A.single(o1))(f(o)))));
}
function mapM(f) {
  return (self) => mapM_(self, f);
}
module.exports = __toCommonJS(mapM_exports);
