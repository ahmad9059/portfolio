...
var bracketExit_exports = {};
__export(bracketExit_exports, {
...
function bracketExit_(acquire, release) {
  return (0, import_managed.managed)(M.makeExit_(acquire, release));
}
function bracketExit(release) {
  return (acquire) => bracketExit_(acquire, release);
}
module.exports = __toCommonJS(bracketExit_exports);
