...
var ensuring_exports = {};
__export(ensuring_exports, {
  ensuring: () => ensuring,
  ensuring_: () => ensuring_
});
...
function ensuring_(self, fin) {
  return new import_definitions.Stream(M.ensuring_(self.proc, fin));
}
function ensuring(fin) {
  return (self) => ensuring_(self, fin);
}
module.exports = __toCommonJS(ensuring_exports);
