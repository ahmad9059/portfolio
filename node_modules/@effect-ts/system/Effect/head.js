...
function head(self, __trace) {
  return (0, import_core.foldCauseM_)(self, (x) => (0, import_core.halt)((0, import_Cause.map_)(x, O.some)), (x) => {
    const it = x[Symbol.iterator]();
    const next = it.next();
    return next.done ? (0, import_fail.fail)(O.none) : (0, import_core.succeed)(next.value);
  }, __trace);
}
