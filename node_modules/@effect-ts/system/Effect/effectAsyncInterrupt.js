...
var effectAsyncInterrupt_exports = {};
__export(effectAsyncInterrupt_exports, {
...
var import_effectMaybeAsyncInterrupt = require("./effectMaybeAsyncInterrupt.js");
...
function effectAsyncInterruptBlockingOn(register, blockingOn, __trace) {
  return (0, import_effectMaybeAsyncInterrupt.effectMaybeAsyncInterruptBlockingOn)((cb) => E.left(register(cb)), blockingOn, __trace);
}
module.exports = __toCommonJS(effectAsyncInterrupt_exports);
