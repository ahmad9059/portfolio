...
function mapBoth_(self, f, g, __trace) {
  return (0, import_foldM.foldM_)(self, (e) => (0, import_fail.fail)(f(e)), (a) => (0, import_core.succeed)(g(a)), __trace);
}
function mapBoth(f, g, __trace) {
  return (self) => mapBoth_(self, f, g, __trace);
}
module.exports = __toCommonJS(mapBoth_exports);
