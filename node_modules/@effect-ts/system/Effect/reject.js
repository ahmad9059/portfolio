...
function rejectM_(self, pf, __trace) {
  return (0, import_core.chain_)(self, (a) => O.fold_(pf(a), () => (0, import_core.succeed)(a), (_) => (0, import_core.chain_)(_, (e1) => (0, import_fail.fail)(e1))), __trace);
}
function reject(pf, __trace) {
  return (self) => reject_(self, pf);
}
function reject_(self, pf, __trace) {
  return rejectM_(self, (x) => O.map_(pf(x), import_fail.fail), __trace);
}
