...
var tapEither_exports = {};
__export(tapEither_exports, {
  tapEither: () => tapEither,
...
function tapEither_(self, f, __trace) {
  return core.chain_((0, import_either.either)(self), (exit) => core.chain_(f(exit), () => (0, import_fromEither.fromEither)(() => exit)));
}
function tapEither(f, __trace) {
  return (self) => tapEither_(self, f, __trace);
}
module.exports = __toCommonJS(tapEither_exports);
