...
export interface FilterableWithIndex<F extends HKT.URIS, C = HKT.Auto> extends FilterWithIndex<F, C>, PartitionWithIndex<F, C>, FilterMapWithIndex<F, C>, PartitionMapWithIndex<F, C> {
}
