...
export interface CollectionBuilder<F extends HKT.URIS, C, A> {
    ...
    readonly build: () => HKT.Kind<F, C, HKT.Initial<C, "K">, HKT.Initial<C, "Q">, HKT.Initial<C, "W">, HKT.Initial<C, "X">, HKT.Initial<C, "I">, HKT.Initial<C, "S">, HKT.Initial<C, "R">, HKT.Initial<C, "E">, A>;
}
