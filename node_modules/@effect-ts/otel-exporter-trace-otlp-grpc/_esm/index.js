...
export const OTLPTraceExporterConfigTag = tag(OTLPTraceExporterConfigSymbol);
export const makeOTLPTraceExporterConfigLayer = (config) => L.fromEffect(OTLPTraceExporterConfigTag)(T.succeedWith(() => new OTLPTraceExporterConfig(config))).setKey(OTLPTraceExporterConfigTag.key);
export const makeOTLPTraceExporterConfigLayerM = (config) => L.fromEffect(OTLPTraceExporterConfigTag)(T.map_(config, (_) => new OTLPTraceExporterConfig(_))).setKey(OTLPTraceExporterConfigTag.key);
export const makeTracingSpanExporter = M.gen(function* (_) {
    const { config } = yield* _(OTLPTraceExporterConfigTag);
    const spanExporter = yield* _(pipe(T.succeedWith(() => new OTLPTraceExporter(config)), 
